          ...
          {routes.map((routeItem, index) => (
            <motion.article
              ...
              className={`glass group rounded-[1.35rem] p-5 shadow-soft transition sm:p-6 ${
                selectedRoute === routeItem.id ? 'border-[color:var(--coral)]/50 ring-2 ring-[color:var(--coral)]/14' : ''
              }`}
            ...
            >
              ...
              <div className="mt-5 rounded-2xl border border-[color:var(--border)]/70 bg-white/46 p-4">
