...
export function MapPreview() {
  ...
  return (
    <section id="map" className="section-shell overflow-hidden bg-[radial-gradient(circle_at_14%_10%,rgba(32,199,189,0.28),transparent_22rem),linear-gradient(145deg,#071a2d,#063b5b_58%,#04111f)] text-white">
      ...
      <div className="section-inner">
        ...
        <div className="mt-9 grid gap-5 lg:grid-cols-[23rem_1fr]">
          ...
          <div className="map-canvas">
            ...
            {filteredPlaces.map((place) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() => setSelectedPlace(place)}
                  className={`absolute z-30 grid size-9 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full border text-white ring-2 ring-white/18 transition ${
                    isActive
            ...
            <div className="glass-dark absolute bottom-5 right-5 z-40 w-[min(22rem,calc(100%-2.5rem))] rounded-[1.25rem] p-4 shadow-glow sm:p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-full bg-[color:var(--sand)] px-3.5 py-2 text-sm font-bold text-[color:var(--ink)]"
                >
                  Open in Google Maps
                  <ExternalLink size={15} aria-hidden="true" />
                </a>
                <button type="button" className="inline-flex items-center gap-2 rounded-full bg-white/12 px-3.5 py-2 text-sm font-bold text-white transition hover:bg-white/18">
